...
Value setgenerate(const Array& params, bool fHelp)
{
    ...
    GenerateGingerCoins(fGenerate, pwalletMain);
    return Value::null;
}
...
Value getwork(const Array& params, bool fHelp)
{
    ...
    if (vNodes.empty())
        throw JSONRPCError(RPC_CLIENT_NOT_CONNECTED, "GingerCoin is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "GingerCoin is downloading blocks...");
